...
def nms(dets, thresh):
    ...
    while index.size > 0:
        ...
        index = index[ious_idx + 1]
    return keep
    
# 使用nms对人脸框进行筛选
# TODO 尝试调整不同的thresh，看看有什么效果
keep = nms(face_boxs, thresh=0.1)
...
cv2.waitKey()
cv2.imwrite('th_0.1png', image_for_nms_box)
cv2.destroyAllWindows()
```

* 阈值为1

![](C:\Users\yalnie\Desktop\项目实战\安防监控之实时口罩人脸检测\week1-作业-NMS\th_1.png)

* 阈值为0.5

![](C:\Users\yalnie\Desktop\项目实战\安防监控之实时口罩人脸检测\week1-作业-NMS\th_0.5.png)

* 阈值为0.3

![](C:\Users\yalnie\Desktop\项目实战\安防监控之实时口罩人脸检测\week1-作业-NMS\th_0.3.png)

* 阈值为0.2

![](C:\Users\yalnie\Desktop\项目实战\安防监控之实时口罩人脸检测\week1-作业-NMS\th_0.2.png)

* 阈值为0.1

![](C:\Users\yalnie\Desktop\项目实战\安防监控之实时口罩人脸检测\week1-作业-NMS\th_0.1.png)
